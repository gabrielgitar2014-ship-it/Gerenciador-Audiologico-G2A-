...
import { generateTextPDF } from '../../../utils/pdfTextGenerator';
...
export function EpidemiologicalReport() {
  ...
  const exportToPDF = () => {
    ...
    // Você deve pegar esses dados reais do seu contexto de usuário no futuro
    ...
    generateTextPDF(
      reportContent,
      `Relatório Epidemiológico PCA - ${year === 'todos' ? 'Histórico' : year}`,
      profName,
      profDoc
    );
  };
