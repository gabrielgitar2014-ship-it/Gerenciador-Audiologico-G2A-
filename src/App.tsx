...
import { PCAManager } from './pages/app/pca/PCAManager';
import { PCADetalhe } from './pages/app/pca/PCADetalhe';

// Módulo EPI
import { EPIHub } from './pages/app/epi/EPIHub';
            ...
            <Routes>
              ...
              <Route element={<ProtectedRoute />}>
                ...
                <Route path="/app/:companyId" element={<AppLayout />}>
                 ...
                 <Route path="pca/gerenciar" element={<PCAManager />} />
                 <Route path="pca/detalhe/:pcaId" element={<PCADetalhe />} />
                 <Route path="pca/prontuario/:workerId" element={<PCAProntuario />} />

                 {/* EPIs */}
                 <Route path="epi" element={<EPIHub />} />
