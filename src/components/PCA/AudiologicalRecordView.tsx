...
export function AudiologicalRecordView({ workerId }: AudiologicalRecordViewProps) {
  ...
  if (loading) {
    return (
      <div className="rounded-[2rem] border border-slate-200/60 bg-white/80 p-10 text-center text-slate-500 shadow-[0_10px_40px_-15px_rgba(15,23,42,0.08)] backdrop-blur-xl">
  ...
  if (!workerInfo) {
    return (
      <div className="rounded-[2rem] border border-red-200/60 bg-red-50/60 p-10 text-center text-red-500 shadow-[0_10px_40px_-15px_rgba(15,23,42,0.08)] backdrop-blur-xl">
    ...
    <div className="space-y-6">
      ...
      >
        <Group align="flex-start" justify="space-between">
          <Group align="flex-start">
            ...
            <div>
              <Text fw={700} size="lg" c="slate.8">{workerInfo.name}</Text>
      ...
      >
        <Group mb="md">
          ...
          <Text fw={600} size="lg" c="slate.8">Histórico de Exames ({allExams.length})</Text>
        </Group>
      ...
      {workerInfo.occTritonal && (workerInfo.occTritonal.OD?.ref_346 !== undefined || workerInfo.occTritonal.OE?.ref_346 !== undefined) && (
        <Paper
          p="xl"
          radius="2rem"
          className="border border-cyan-200/70 bg-gradient-to-br from-cyan-50/80 to-white shadow-[0_10px_40px_-15px_rgba(8,145,178,0.12)] backdrop-blur-xl"
        >
          <Group mb="md">
            <ThemeIcon size="lg" radius="xl" color="cyan" variant="light">
            ...
            <div>
              <Text fw={600} size="lg" c="cyan.9">Análise de Desencadeamento/Agravamento (NR-07 Anexo II)</Text>
            ...
            {['OD', 'OE'].map((ear) => {
              ...
              return (
                <Grid.Col span={{ base: 12, md: 6 }} key={ear}>
                  <Paper p="md" radius="lg" withBorder className="border-slate-200/70 bg-white/90">
